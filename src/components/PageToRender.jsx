...
function PageToRender() {
    ...
    const [data, setData] = useState(
        prodcutData.filter((e) => e.gender === "M")
    );
    ...
    const openProductModal = () => {
        if (modalShirt.name !== undefined) {
            ...
            returnData.push(
                <div className="other-image-wrapper">{imageData}</div>
            );
            ...
            returnData.push(
                <div id="modal-meta-data">
                    ...
                    <div>
                        {modalShirt.finalPrice
                            ? "Rs. " + modalShirt.finalPrice
                            : ""}
                    </div>
                    <div>
                        <strike>
                            {modalShirt.strickPrice
                                ? "Rs. " + modalShirt.strickPrice
                                : ""}
                        </strike>
                    </div>
                    <div style={{ color: "red" }}>
                    ...
                    <div className="size-chart-holder">
                        ...
                        <div className="size-chart-option-holder">
                            {sizeOption}
                        </div>
                    </div>
                </div>
    ...
    const openCartModal = () => {
        ...
        shoppingCart.forEach((element) => {
            ...
            totalSave +=
                parseInt(element.strickPrice) - parseInt(element.finalPrice);
            totalItem++;
            ...
            >
                ...
                <div className={"indiv-tile-metaData"}>
                    ...
                    <div>
                        ...
                        <strike>
                            <div
                                style={{ fontSize: "0.8em", display: "inline" }}
                            >
                                {data.strickPrice}
                            </div>
                        </strike>
            ...
            <nav className="top-nav">
                ...
                <div className="nav-line">
                    ...
                    >
                        ...
                        <div className={"cart-list-length"}>
                            {shoppingCart.length}
                        </div>
                    </div>
                </div>
                            ...
                            <div className={"indiv-cat-checkbox"}>
                                <input
                                    ...
                                    onClick={() => {
                                        updateShirtList({
                                            ...filtertList,
                                            folded: filtertList.folded
                                                ? false
                                                : true,
                                        });
                                    }}
                                ></input>{" "}
                                <div className={"indiv-cat-text"}>
                                    Folded Sleeves
                                </div>
                            </div>
                        </div>
